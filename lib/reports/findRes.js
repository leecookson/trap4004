...
var userToFileName = require('../util/userToFileName');
...
//    console.log('Game Time Now: ', toSimpleTime(gameTime));
    ...
    var outputFile = path.resolve(process.env.HOME, 'reports', farmMode ? 'farmers.html' : 'losers.html');
...
function generateReport(reportData) {
  var templateFile = fs.readFileSync('view/farmerLoser.mu', 'utf-8').toString();
  var headerFile = fs.readFileSync('view/header.mu', 'utf-8').toString();
